...
| `STS2_ORIGINAL_V1100_ROOT` 或 `STS2_ORIGINAL_V1100_REFERENCE_DIR` | 当前 v0.110.0 public-beta target 的 original compile gate。 |
...
| `compat.default_reference_flavor` | `original-v0.110.0` | 当前 v0.110.0 public-beta fallback 的默认 compile gate；旧 v0.109.x flavor 仍可显式选择。 |
