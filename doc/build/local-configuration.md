...
| `STS2_ORIGINAL_V1090_ROOT` 或 `STS2_ORIGINAL_V1090_REFERENCE_DIR` | 共享 v0.109.x public-beta target 的 original compile gate；变量名为兼容旧脚本保留，当前应指向最新 v0.109.1 引用。 |
...
| `compat.default_reference_flavor` | `original-v0.109.0` | 当前共享 v0.109.x fallback 的默认 compile gate；flavor 名保留不变，引用使用最新 v0.109.1。 |
