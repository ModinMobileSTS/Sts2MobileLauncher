...
| `STS2_ORIGINAL_V1071_ROOT` 或 `STS2_ORIGINAL_V1071_REFERENCE_DIR` | v0.107.1 beta original compile gate 引用。 |
...
| `compat.default_reference_flavor` | `original-v0.107.1` | 当前分支 fallback 的默认 compile gate。 |
