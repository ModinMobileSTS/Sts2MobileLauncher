...
| Beta 当前测试 | `v0.110.0` | `.env` 的 `STS2_ORIGINAL_V1100_REFERENCE_DIR` 或 `STS2_ORIGINAL_V1100_ROOT` | — | `original-v0.110.0` | `v0.110.0` | — |

v0.109.1 与 v0.109.0 的托管 API/方法 IL 相同，资源变化仅为繁体中文本地化，因此共用同一个 variant；保留 target id 与 ReferenceFlavor 历史名称可避免已有 launch profile 失效。v0.110.0 修改了输入、联机版本信息、存档与部分玩法 API，因此使用独立 target；其原版 DLL SHA-256 为 `7a2592364fdc6ff4c42bb5f1ff41f9fa12155f84de772e203ace1b088ebb607d`。
